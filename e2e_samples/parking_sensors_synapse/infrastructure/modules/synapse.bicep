...
param synStorageAccount string = '${RESOURCE_GROUP_NAME_PREFIX}st2${env}${deployment_id}'
param mainStorageAccount string = '${RESOURCE_GROUP_NAME_PREFIX}st${env}${deployment_id}'
param synStorageFileSys string = 'synapsedefaultfs'
param keyvault string = '${RESOURCE_GROUP_NAME_PREFIX}-kv-${env}-${deployment_id}'
...
resource synapseWorkspace 'Microsoft.Synapse/workspaces@2021-03-01' = {
  ...
  properties: {
    ...
    managedResourceGroupName: '${RESOURCE_GROUP_NAME_PREFIX}-syn-mrg-${env}-${deployment_id}'
